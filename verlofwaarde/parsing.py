...
def _read_first_sheet(file: IO[bytes] | str) -> pd.DataFrame:
    # Gebruik openpyxl in read_only mode: dit slaat stylesheet-parsing volledig
    # over en voorkomt de TypeError op Python 3.13+ met bepaalde xlsx-bestanden
    # (bv. exports uit salarisadministraties met exotische fill-styles).
